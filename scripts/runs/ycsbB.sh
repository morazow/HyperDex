...
java -Djava.library.path=/home/morazow/hyperdex_install/lib com.yahoo.ycsb.Client -t -db hyperclient.HyperClientYCSB \
    -p "hyperclient.host=${HD_COORDINATOR_HOST}" \
    -p "hyperclient.port=${HD_COORDINATOR_DATA_PORT}" \
    -P /home/morazow/scripts/workloads/workloadB -p threads=16 \
    -p recordcount=1000000 -p operationcount=1000000 -s
