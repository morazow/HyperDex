                        ...
                        try {
                            ...
                            while (s.hasNext()) {
                                ...
                                if ((end - begin) / NANO > duration) {
                                    System.out.println("Search Latency = " + ls + " DID_NOT_FINISH Counter = "+(cnt+1)+" ID = "+id+" Error = "
                                    +error+" Region = "+region);
                                    break hello; 
                                }
                            }
                            ...
                            System.out.println("Search Latency = " + ls + " Next Latency = "+(le - lb)+" Counter = "+cnt+" ID = "+id+" Error = "
                            +error+" Region = "+region);
